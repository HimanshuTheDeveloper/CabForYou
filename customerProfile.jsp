...
<%
    ...
    try
    {
        ...
        String query="select * from customer where customer_id ="+session.getAttribute("customerId");
    ...
    <div class="container">
        <div class="list">
            ...
            <ul>
                ...
                <li  class="active"><a href="customerProfile.jsp">User Profile</a></li>
                <li><a href="logout.jsp">logged out</a></li>
                        
            </ul>
        </div>
        <br><br><br><br><br><br>
         <h1 id="header">Customer Profile</h1>
             ...
             <div class="content">
                    ...
                    <tr>
                        ...
                        <td><p id="customerId"><%out.print(session.getAttribute("customerId"));%></p></td>
                    ...
                    <tr>
                        <td>  <p>E-mail ::</p> </td>
                        <td><p id="email"><%out.print(rs.getString("email"));%></p></td>
                    </tr>
                    <tr>
                        <td>  <p>Gender ::</p> </td>
                    ...
                    <tr>
                        <td>  <p>Password ::</p> </td>
                        <td><p id="password"><%out.print(rs.getString("password"));%></p></td>
                    </tr>
...
<script>
    ...
    function editProfile()
    {
        ...
        xmlhttp.open("POST", "editProfile.jsp" + param, false);
